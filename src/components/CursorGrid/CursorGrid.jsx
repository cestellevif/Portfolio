// CursorGrid — canvas-based interactive grid that lights up near the cursor.
// Source: React Bits (open source). Props documented in the usage comment below.
// Usage: <CursorGrid color="#2D2D2D" cellSize={55} radius={160} gridOpacity={0.1} />

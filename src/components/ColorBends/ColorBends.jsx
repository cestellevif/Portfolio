// ColorBends — animated color gradient background from React Bits (open source).
// Source: reactbits.dev/backgrounds/color-bends
// Uses vanilla Three.js (no R3F). Renders a full-canvas GLSL shader via an
// orthographic camera + plane geometry. Fills its container div.
